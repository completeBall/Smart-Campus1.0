<template>
  <div class="approvals-page">
      ...
      <el-tab-pane label="请假审批" name="leave">
        <el-card>
          ...
          <el-table :data="leaveList" border stripe v-loading="leaveLoading">
            ...
            <el-table-column prop="type" label="请假类型" width="90">
              <template #default="{ row }">
                <el-tag :type="leaveTypeMap[row.type]?.type" size="small">{{ leaveTypeMap[row.type]?.label }}</el-tag>
              </template>
            </el-table-column>
    ...
    <el-dialog v-model="leaveDialogVisible" title="审批请假" width="450px">
...
const leaveForm = reactive({ id: null, student_name: '', class_name: '', start_date: '', end_date: '', reason: '', status: 1, reply: '' })
